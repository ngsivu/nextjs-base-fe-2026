		...
		<>
			...
			<div className="max-w-7xl px-6 mx-auto">
				<div className="lg:grid lg:grid-cols-[220px_minmax(0,1fr)] lg:gap-12">
					...
					<aside className="py-8 lg:sticky lg:top-14 lg:h-[calc(100dvh-3.5rem)] lg:border-r lg:pr-6 border-border">
						<ShowcaseNav groups={NAV_GROUPS} />
					</aside>

					<main className="min-w-0 py-8 lg:py-12">
						<header className="pb-8 border-b border-border">
							<p className="mb-3 text-eyebrow text-primary-text uppercase">Gallery</p>
							<h1 className="sm:text-display-lg text-display-md">Components</h1>
