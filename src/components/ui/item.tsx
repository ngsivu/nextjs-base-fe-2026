...
function ItemDescription({ className, ...props }: React.ComponentProps<'p'>) {
	return (
		<p
			...
			className={cn(
				'text-sm leading-normal font-normal group-data-[size=xs]/item:text-xs line-clamp-2 text-left text-muted-foreground [&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-primary-text',
				className,
			)}
			{...props}
		/>
