...
function NavigationMenuLink({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Link>) {
	return (
		<NavigationMenuPrimitive.Link
			...
			className={cn(
				"gap-2 p-2 text-sm [&_svg:not([class*='size-'])]:size-4 flex items-center rounded-lg transition-all outline-none hover:bg-muted focus:bg-muted focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-md data-active:bg-muted/50 data-active:hover:bg-muted data-active:focus:bg-muted",
				className,
			)}
			{...props}
		/>
...
function NavigationMenuIndicator({
	...
	return (
		<NavigationMenuPrimitive.Indicator
			...
			{...props}
		>
			<div className="h-2 w-2 relative top-[60%] rotate-45 rounded-tl-sm bg-border shadow-md" />
		</NavigationMenuPrimitive.Indicator>
	);
}
